...
$openjvsversion = shell_exec('openjvs --version');

$ojvsfile = '/etc/openjvs/config';
$searchfor = 'ttyAMA';
$contents = file_get_contents($ojvsfile);
$pattern = preg_quote($searchfor, '/');
$pattern = "/^.*$pattern.*\$/m";
if(preg_match_all($pattern, $contents, $matches)){
    $openjvshat = 'enabled';
...
<?php
echo '<a href="setup.php">Current Version: '.$openjvsversion;
echo '</a><br><br>';
?>
<div class="box2">
...
<?php
if ($openjvshat == 'disabled'){
echo '<div class="box2">';
echo '<a href="updateopenjvshat.php">Enable HAT Support</a><br></div><br>';
}
if ($rotarymode == 'rotaryon'){
echo '<div class="box2">';
echo '<a href="editrotarymappings.php">Rotary Mappings</a></div><br>';
}
?>
<div class="box2">
