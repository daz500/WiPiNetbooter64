...
path = '/var/www/html/cards/'+wmmtmode+'/'
...
# Detect if new card print on existing card, if so reset all card values apart from card name
...
# If not found create a blank one
    ...
    cardimage = random.choice(os.listdir("/var/www/html/cardimages/"+wmmtmode))
